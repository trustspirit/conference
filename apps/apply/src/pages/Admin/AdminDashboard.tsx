...
function getPositionNames(
  items: Array<Pick<Application | LeaderRecommendation, 'positionName'>>,
  fallback: string
): string[] {
...
export default function AdminDashboard() {
  ...
  const positionNames = useMemo(
    () => getPositionNames(allItems, unspecified),
  ...
  return (
    <div className="mx-auto max-w-7xl p-6">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">
        {t('admin.dashboard.title', '관리자 대시보드')}
      </h1>
      <p className="text-sm text-gray-500 mb-6">
        {t('admin.dashboard.subtitle', '신청서와 추천서 현황을 한눈에 확인하세요.')}
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">
            {t('admin.dashboard.charts.trendTitle', '7일 추세')}
          </h3>
            ...
            <ResponsiveContainer width="100%" height={220}>
              <LineChart data={trendData}>
                ...
                <Line
                  ...
                  strokeWidth={2}
                  dot={{ r: 3 }}
                  name={t('admin.recommendations', '추천서')}
                />
              </LineChart>
            </ResponsiveContainer>
          )}
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">
            {t('admin.dashboard.charts.positionDistribution', '포지션별 신청 현황')}
          </h3>
          {positionData.length > 0 ? (
            <ResponsiveContainer width="100%" height={220}>
              <BarChart data={positionData}>
                ...
                <Bar
                  dataKey="value"
                  name={t('admin.dashboard.charts.submissions', '제출 수')}
                  radius={[4, 4, 0, 0]}
                  fill="#6366f1"
                />
              </BarChart>
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">
            {t('admin.dashboard.charts.genderByPosition', '포지션별 성별 분포')}
          </h3>
        ...
        <div className="rounded-xl bg-white border border-gray-200 p-5 lg:col-span-2">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">
            {t('admin.dashboard.charts.stakeByPosition', '스테이크별 포지션 분포')}
          </h3>
