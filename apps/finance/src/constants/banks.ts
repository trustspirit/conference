...
export const BANKS: BankInfo[] = [
  { code: 'kb', name: 'KB국민은행', format: [3, 2, 4, 5], maxDigits: 14 },
  { code: 'shinhan', name: '신한은행', format: [3, 3, 6], maxDigits: 12 },
  { code: 'woori', name: '우리은행', format: [4, 3, 7], maxDigits: 14 },
  ...
  { code: 'daegu', name: '대구은행', format: [3, 2, 6, 3], maxDigits: 14 },
  { code: 'busan', name: '부산은행', format: [4, 3, 7], maxDigits: 14 },
  { code: 'gwangju', name: '광주은행', format: [3, 3, 7], maxDigits: 13 },
  { code: 'jeonbuk', name: '전북은행', format: [3, 2, 8], maxDigits: 13 },
  { code: 'jeju', name: '제주은행', format: [2, 2, 8], maxDigits: 12 },
  { code: 'suhyup', name: '수협', format: [3, 2, 8], maxDigits: 13 },
  { code: 'saemaeul', name: '새마을금고', format: [4, 3, 7], maxDigits: 14 },
  { code: 'shinhyup', name: '신협', format: [3, 3, 8], maxDigits: 14 },
