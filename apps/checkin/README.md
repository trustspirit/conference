...
이름, 이메일, 전화번호 또는 QR 코드로 참가자를 검색하고 빠르게 체크인/체크아웃합니다.

![참가자 체크인](docs/screenshots/home-search.png)

### 참가자 목록

전체 참가자를 조회하고, 체크인 상태별 필터링, 검색, 일괄 배정, CSV 내보내기를 지원합니다.

![참가자 목록](docs/screenshots/participants.png)

### 그룹 관리

태그(남성/여성/커스텀) 기반 그룹 분류, 필터링/정렬, 리더 지정, CSV 가져오기, 명단 인쇄를 지원합니다.

![그룹 관리](docs/screenshots/groups.png)

### 객실 관리

성별/유형별 필터링, 수용 현황 표시, 방장 지정, 배정표 인쇄를 지원합니다.

![객실 관리](docs/screenshots/rooms.png)
